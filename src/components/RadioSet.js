        ...
        <section className="radio-set--playlist-container">
          <Playlist
            ...
            toggleFavorite={index =>
              this.toggleFavorite(index, "morningTracks")
            }
            sendToTop={index =>
              this.sendToTop(index, "morningTracks", "eveningTracks")
            }
            switchLists={index =>
              this.switchLists(index, "morningTracks", "eveningTracks")
            }
          />
          <Playlist
            side="Evening"
            ...
            toggleFavorite={index =>
              this.toggleFavorite(index, "eveningTracks")
            }
            sendToTop={index => this.sendToTop(index, "eveningTracks")}
            switchLists={index =>
              this.switchLists(index, "eveningTracks", "morningTracks")
            }
          />
        </section>
      </div>
